<script setup lang="ts" name="TeekLayoutProvider">
    ...
    import { teekDocConfig } from "../setting/teekConfig.mts";
    import { useRibbon } from "../composables/useRibbon.mts";
    ...
    watch(
        ...
        (newVal) =>
            setTimeout(
                () => watchRuntimeAndRibbon(newVal.layout, currentStyle.value),
                700
            ),
        {
            immediate: true,
